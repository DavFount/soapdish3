        ...
        <div class="grid grid-cols-3 gap-4">
            <div v-for="user in users.data" :key="user.id">
                <Card>
                    ...
                    <template #socials v-if="user.socials.facebook || user.socials.twitter || user.socials.instagram">
                        <div class="flex justify-start gap-x-4">
                            ...
                            <div v-if="user.socials.twitter">
                                <a :href="'https://twitter.com/' + user.socials.twitter" target="_blank">
                                    <svg fill="#6b7280" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid"
                                         class="w-6 h-6"
